            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <ul className="body-2 ">
                {brainwaveServices.map((item, index) => (
                  ...
                  >
                    <img src={check} alt="Check Mark" width={24} height={24} />
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                ...
                <p className="body-2 mb-[3rem] text-n-3">
                  Enhance your photos using AI app's photo editing feature. Try
                  it NOW!
                </p>
              </div>
              <PhotoChatMessage />
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="px-4 py-12 xl:px-8">
                ...
                <p className="body-2 mb-[2rem] text-n-3">
                  The world's most powerfull AI video generation engin. What
                  will you create?
                </p>
